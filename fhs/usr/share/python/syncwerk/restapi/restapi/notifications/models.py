...
from restapi.utils.repo import get_repo_shared_users
from restapi.utils import normalize_cache_key
...
from restapi.signals import upload_file_successful, comment_file_successful
from restapi.group.signals import grpmsg_added, group_join_request, add_user_to_group
from restapi.share.signals import share_repo_to_user_successful, \
    share_repo_to_group_successful
from restapi.invitations.signals import accept_guest_invitation_successful
...
def grpmsg_added_cb(sender, **kwargs):
    ...
    group_members = synserv.get_group_members(int(group_id))
