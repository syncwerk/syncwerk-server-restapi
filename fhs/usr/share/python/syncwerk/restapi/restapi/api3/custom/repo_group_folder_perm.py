...
from restapi.utils import is_org_context, is_pro_version, send_perm_audit_msg
...
class RepoGroupFolderPerm(APIView):
    ...
    def post(self, request, repo_id, format=None):
        ...
        for group_id in group_ids:
            ...
            try:
                ...
                send_perm_audit_signal(request, 'add-repo-perm', repo_id, path, perm, group_id, 'group')
    ...
    def put(self, request, repo_id, format=None):
        ...
        try:
            ...
            send_perm_audit_signal(request, 'modify-repo-perm', repo_id, path, perm, group_id, 'group')
            new_perm = syncwerk_api.get_folder_group_perm(repo_id, path, group_id)
