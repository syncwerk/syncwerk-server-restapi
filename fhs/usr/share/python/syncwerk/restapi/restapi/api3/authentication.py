...
from restapi.api3.utils import get_client_ip
from restapi.utils import within_time_range
...
HEADER_CLIENT_VERSION = 'HTTP_X_SYNCWERK_CLIENT_VERSION'
HEADER_PLATFORM_VERSION = 'HTTP_X_SYNCWERK_PLATFORM_VERSION'
    ...
    * user -- The user to which the token belongs
    ...
    def authenticate(self, request):
        ...
        if not key:
            ...
            return
        if ' ' in key:
            msg = 'Invalid token cookie. Token string should not contain spaces.'
