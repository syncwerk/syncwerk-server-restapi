...
class DirRestore(APIView):
    ...
    @swagger_auto_schema(
        ...
        operation_summary='Restore subfolder',
        operation_description='''Restore subfolder from trash''',
        tags=['folders'],
        manual_parameters=[
            openapi.Parameter(
                name='repo_id',
            ...
            openapi.Parameter(
                ...
                in_="formData",
                type='string',
                description='path of the subfolder to be restored',
            ),
            openapi.Parameter(
                name='commit_id',
                in_="formData",
    ...
    def put(self, request, repo_id):
        ...
        return api_response(msg='Folder restored successfully.')
