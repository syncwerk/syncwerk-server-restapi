...
from restapi.avatar.forms import PrimaryAvatarForm, DeleteAvatarForm, UploadAvatarForm,\
    GroupAvatarForm
from restapi.avatar.models import Avatar, GroupAvatar
from restapi.avatar.settings import AVATAR_MAX_AVATARS_PER_USER, AVATAR_DEFAULT_SIZE
from restapi.avatar.signals import avatar_updated
from restapi.avatar.util import get_primary_avatar, get_default_avatar_url, \
    invalidate_cache, invalidate_group_cache
from restapi.utils import render_error, render_permission_error

from restapi.auth.decorators import login_required
from synserv import ccnet_threaded_rpc, check_group_staff
