...
from restapi.avatar.settings import (GROUP_AVATAR_DEFAULT_SIZE, AVATAR_CACHE_TIMEOUT,
                             GROUP_AVATAR_DEFAULT_URL)
from restapi.avatar.models import GroupAvatar
from restapi.avatar.util import get_grp_cache_key
