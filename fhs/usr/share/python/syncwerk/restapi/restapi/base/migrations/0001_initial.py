    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', restapi.base.fields.LowerCaseCharField(max_length=16)),
                ('pversion', restapi.base.fields.LowerCaseCharField(max_length=16)),
            ],
        ),
        migrations.CreateModel(
            name='FileComment',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('author', restapi.base.fields.LowerCaseCharField(db_index=True, max_length=255)),
