...
from restapi.wiki.models import PersonalWiki, GroupWiki
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        self.all_repo= [repo.repo_id for repo in syncwerk_api.get_repo_list(-1, -1)]
        trash_repo = [repo.repo_id for repo in syncwerk_api.get_trash_repo_list(-1, -1)]
