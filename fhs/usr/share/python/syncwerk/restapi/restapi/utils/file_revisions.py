...
from restapi.settings import GET_FILE_HISTORY_TIMEOUT
...
def get_file_revisions_within_limit(repo_id, path, commit_id=None, limit=50):
    ...
    file_revisions = syncwerk_api.get_file_revisions(repo_id,
...
def get_all_file_revisions(repo_id, path, commit_id=None):
    ...
    # if commit's rev_renamed_old_path value not None, syncwerk will stop searching.
