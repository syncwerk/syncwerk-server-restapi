...
from restapi.two_factor import login as two_factor_login
from restapi.two_factor.models import (StaticDevice, TOTPDevice, default_device,
                                      user_has_device)

from restapi.two_factor.forms import TOTPTokenAuthForm, BackupTokenAuthForm, AuthenticationTokenForm
from restapi.two_factor.views.utils import class_view_decorator
...
class TwoFactorVerifyView(SessionWizardView):
    ...
    storage_name = 'restapi.two_factor.views.utils.ExtraSessionStorage'
