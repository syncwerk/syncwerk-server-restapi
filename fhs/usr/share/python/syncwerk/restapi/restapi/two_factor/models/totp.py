...
from restapi.two_factor.oath import TOTP
from restapi.two_factor.utils import random_hex, hex_validator
...
class TOTPDevice(Device):
    """
    A generic TOTP :class:`~restapi.django_otp.models.Device`. The model fields mostly
    correspond to the arguments to :func:`restapi.two_factor.oath.totp`. They all have
