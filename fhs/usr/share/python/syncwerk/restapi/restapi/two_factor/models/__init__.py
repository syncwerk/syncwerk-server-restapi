...
from restapi.two_factor.models.base import Device, get_available_methods
from restapi.two_factor.models.totp import TOTPDevice
from restapi.two_factor.models.phone import PhoneDevice
from restapi.two_factor.models.static import StaticDevice, StaticToken
...
def devices_for_user(user):
    ...
    :type user: :class:`~restapi.auth.models.User`
...
from restapi.auth.signals import user_logged_in
from restapi.two_factor import login
