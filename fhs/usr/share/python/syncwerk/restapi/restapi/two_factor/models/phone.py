...
from restapi.two_factor.gateways import make_call, send_sms
from restapi.two_factor.utils import random_hex
...
class PhoneDevice(Device):
    ...
    def verify_token(self, token):
        ...
        from restapi.two_factor.utils import totp_digits
