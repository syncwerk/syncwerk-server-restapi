...
def login(request, device):
    ...
    This is called automatically any time :func:`restapi.auth.login` is
    called with a user having an ``otp_device`` atribute. If you use Django's
    :func:`~restapi.auth.views.login` view with the django-otp
    ...
    :type device: :class:`~restapi.django_otp.models.Device`
    """
