...
from restapi.auth import login as login, REDIRECT_FIELD_NAME
...
from restapi.two_factor.decorators import otp_required
from restapi.two_factor.models import (StaticDevice, PhoneDevice,
                                      get_available_methods, default_device)
from restapi.two_factor.utils import random_hex, totp_digits, get_otpauth_url

from restapi.two_factor.forms import (MethodForm, TOTPDeviceForm,
