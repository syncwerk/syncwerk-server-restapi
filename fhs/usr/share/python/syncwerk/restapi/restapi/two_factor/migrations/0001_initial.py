...
import restapi.two_factor.models.base
import restapi.two_factor.models.totp
import restapi.two_factor.utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', restapi.base.fields.LowerCaseCharField(help_text='The user that this device belongs to.', max_length=255, unique=True)),
                ('name', models.CharField(help_text='The human-readable name of this device.', max_length=64)),
                ('confirmed', models.BooleanField(default=True, help_text='Is this device ready for use?')),
                ('number', models.CharField(max_length=40)),
                ('key', models.CharField(default=restapi.two_factor.utils.random_hex, help_text='Hex-encoded secret key', max_length=40, validators=[restapi.two_factor.models.base.key_validator])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='The human-readable name of this device.', max_length=64)),
                ('confirmed', models.BooleanField(default=True, help_text='Is this device ready for use?')),
                ('key', models.CharField(default=restapi.two_factor.models.totp.default_key, help_text='A hex-encoded secret key of up to 40 bytes.', max_length=80, validators=[restapi.two_factor.models.totp.key_validator])),
