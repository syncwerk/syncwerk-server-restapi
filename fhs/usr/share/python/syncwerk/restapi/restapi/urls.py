# Copyright (c) 2016-2019 Syncwerk GmbH
# Copyright (c) 2012-2016 Seafile Ltd.

from django.conf.urls import url
# from rest_framework_swagger.views import get_swagger_view

# schema_view = get_swagger_view(title='Syncwerk API')
...
from restapi.views.sysadmin import *
from restapi.views.ajax import *
from restapi.views.sso import *

from restapi.views.file import view_history_file, view_trash_file,\
...
from restapi.views.repo import repo_history_view, view_shared_dir, \
    view_shared_upload_link
from notifications.views import notification_list
from restapi.views.wiki import personal_wiki, personal_wiki_pages, \
    personal_wiki_create, personal_wiki_page_new, personal_wiki_page_edit, \
    personal_wiki_page_delete, personal_wiki_use_lib
from restapi.api2.endpoints.smart_link import SmartLink, SmartLinkToken
from restapi.api2.endpoints.groups import Groups, Group
from restapi.api2.endpoints.all_groups import AllGroups
from restapi.api2.endpoints.shareable_groups import ShareableGroups
from restapi.api2.endpoints.group_libraries import GroupLibraries, GroupLibrary

from restapi.api2.endpoints.group_owned_libraries import GroupOwnedLibraries, \
...
from restapi.api2.endpoints.address_book.groups import AddressBookGroupsSubGroups
from restapi.api2.endpoints.address_book.members import AddressBookGroupsSearchMember

from restapi.api2.endpoints.group_members import GroupMembers, GroupMembersBulk, GroupMember
from restapi.api2.endpoints.search_group import SearchGroup
from restapi.api2.endpoints.share_links import ShareLinks, ShareLink, \
        ShareLinkOnlineOfficeLock
from restapi.api2.endpoints.shared_folders import SharedFolders
from restapi.api2.endpoints.shared_repos import SharedRepos, SharedRepo
from restapi.api2.endpoints.upload_links import UploadLinks, UploadLink, \
        UploadLinkUpload
from restapi.api2.endpoints.repos_batch import ReposBatchView, \
        ReposBatchCopyDirView, ReposBatchCreateDirView, \
        ReposBatchCopyItemView, ReposBatchMoveItemView
from restapi.api2.endpoints.repos import RepoView
from restapi.api2.endpoints.file import FileView
from restapi.api2.endpoints.file_history import FileHistoryView
from restapi.api2.endpoints.dir import DirView, DirDetailView
from restapi.api2.endpoints.file_tag import FileTagView
from restapi.api2.endpoints.file_tag import FileTagsView
from restapi.api2.endpoints.repo_trash import RepoTrash
from restapi.api2.endpoints.deleted_repos import DeletedRepos
from restapi.api2.endpoints.repo_history import RepoHistory
from restapi.api2.endpoints.repo_set_password import RepoSetPassword
from restapi.api2.endpoints.zip_task import ZipTaskView
from restapi.api2.endpoints.share_link_zip_task import ShareLinkZipTaskView
from restapi.api2.endpoints.query_zip_progress import QueryZipProgressView
from restapi.api2.endpoints.cancel_zip_task import CancelZipTaskView
from restapi.api2.endpoints.copy_move_task import CopyMoveTaskView
from restapi.api2.endpoints.query_copy_move_progress import QueryCopyMoveProgressView
from restapi.api2.endpoints.move_folder_merge import MoveFolderMergeView
from restapi.api2.endpoints.invitations import InvitationsView, InvitationsBatchView
from restapi.api2.endpoints.invitation import InvitationView
from restapi.api2.endpoints.notifications import NotificationsView, NotificationView
from restapi.api2.endpoints.user_enabled_modules import UserEnabledModulesView
from restapi.api2.endpoints.repo_file_uploaded_bytes import RepoFileUploadedBytesView
from restapi.api2.endpoints.user_avatar import UserAvatarView
from restapi.api2.endpoints.wikis import WikisView, WikiView
from restapi.api2.endpoints.wiki_pages import WikiPageView, WikiPagesView, WikiPagesDirView, WikiPageContentView
from restapi.api2.endpoints.revision_tag import TaggedItemsView, TagNamesView
from restapi.api2.endpoints.user import User
from restapi.api2.endpoints.webdav_secret import WebdavSecretView

# Admin
from restapi.api2.endpoints.admin.revision_tag import AdminTaggedItemsView
from restapi.api2.endpoints.admin.login_logs import LoginLogs, AdminLoginLogs
from restapi.api2.endpoints.admin.file_audit import FileAudit
from restapi.api2.endpoints.admin.file_update import FileUpdate
from restapi.api2.endpoints.admin.perm_audit import PermAudit
from restapi.api2.endpoints.admin.sysinfo import SysInfo
from restapi.api2.endpoints.admin.statistics import (
...
from restapi.api2.endpoints.admin.devices import AdminDevices
from restapi.api2.endpoints.admin.device_errors import AdminDeviceErrors
from restapi.api2.endpoints.admin.users import AdminUsers, AdminUser
from restapi.api2.endpoints.admin.device_trusted_ip import AdminDeviceTrustedIP
from restapi.api2.endpoints.admin.libraries import AdminLibraries, AdminLibrary
from restapi.api2.endpoints.admin.library_dirents import AdminLibraryDirents, AdminLibraryDirent
from restapi.api2.endpoints.admin.system_library import AdminSystemLibrary, \
        AdminSystemLibraryUploadLink
from restapi.api2.endpoints.admin.default_library import AdminDefaultLibrary
from restapi.api2.endpoints.admin.trash_libraries import AdminTrashLibraries, AdminTrashLibrary
from restapi.api2.endpoints.admin.groups import AdminGroups, AdminGroup
from restapi.api2.endpoints.admin.group_libraries import AdminGroupLibraries, AdminGroupLibrary
from restapi.api2.endpoints.admin.group_members import AdminGroupMembers, AdminGroupMember
from restapi.api2.endpoints.admin.shares import AdminShares
from restapi.api2.endpoints.admin.share_links import AdminShareLink, \
        AdminShareLinkDownload, AdminShareLinkCheckPassword, \
        AdminShareLinkDirents
from restapi.api2.endpoints.admin.upload_links import AdminUploadLink, \
        AdminUploadLinkUpload, AdminUploadLinkCheckPassword
from restapi.api2.endpoints.admin.users_batch import AdminUsersBatch
from restapi.api2.endpoints.admin.operation_logs import AdminOperationLogs
from restapi.api2.endpoints.admin.organizations import AdminOrganization
from restapi.api2.endpoints.admin.org_users import AdminOrgUsers, AdminOrgUser
from restapi.api2.endpoints.admin.org_stats import AdminOrgStatsTraffic
from restapi.api2.endpoints.admin.logo import AdminLogo
from restapi.api2.endpoints.admin.favicon import AdminFavicon
from restapi.api2.endpoints.admin.license import AdminLicense
from restapi.api2.endpoints.admin.invitations import InvitationsView as AdminInvitationsView
from restapi.api2.endpoints.admin.library_history import AdminLibraryHistoryLimit
from restapi.api2.endpoints.admin.login_bg_image import AdminLoginBgImage
from restapi.api2.endpoints.admin.admin_role import AdminAdminRole
from restapi.api2.endpoints.admin.address_book.groups import AdminAddressBookGroups, \
        AdminAddressBookGroup
from restapi.api2.endpoints.admin.group_owned_libraries import AdminGroupOwnedLibraries, \
        AdminGroupOwnedLibrary

urlpatterns = [
    # url(r'^$', schema_view),

    url(r'^accounts/', include('restapi.base.registration_urls')),

    url(r'^sso/$', sso, name='sso'),
    url(r'^shib-login/', shib_login, name="shib_login"),
    url(r'^oauth/', include('restapi.oauth.urls')),
    ...
    ### Apps ###
    url(r'^api2/', include('restapi.api2.urls')),
    url(r'^api3/', include('restapi.api3.urls')),
    # url(r'^api3/docs/', schema_view, name='schema_view'),
    ...
    url(r'^avatar/', include('restapi.avatar.urls')),
    url(r'^notification/', include('restapi.notifications.urls')),
    url(r'^contacts/', include('restapi.contacts.urls')),
    url(r'^group/', include('restapi.group.urls')),
    url(r'^options/', include('restapi.options.urls')),
    url(r'^profile/', include('restapi.profile.urls')),
    url(r'^share/', include('restapi.share.urls')),
    url(r'^help/', include('restapi.help.urls')),
    url(r'^captcha/', include('captcha.urls')),
    url(r'^thumbnail/', include('restapi.thumbnail.urls')),
    url(r'^inst/', include('restapi.tenants.urls', app_name='tenants', namespace='tenants')),
    url(r'^invite/', include('restapi.invitations.urls', app_name='invitations', namespace='invitations')),
    url(r'^terms/', include('termsandconditions.urls')),
    url(r'^wikis/', include('restapi.wiki.urls', app_name='wiki', namespace='wiki')),
    ...
    url(r'^sys/syncwadmin/delete/(?P<repo_id>[-0-9a-f]{36})/$', sys_repo_delete, name='sys_repo_delete'),
...
from restapi.utils import EVENTS_ENABLED
if EVENTS_ENABLED:
    urlpatterns += [
...
from restapi.utils import HAS_FILE_SEARCH
if HAS_FILE_SEARCH:
    from restapi_extra.search.views import search, pubuser_search
    urlpatterns += [
...
if getattr(settings, 'ENABLE_PAYMENT', False):
    urlpatterns += [
        url(r'^pay/', include('restapi_extra.pay.urls')),
    ]


if getattr(settings, 'ENABLE_SYSADMIN_EXTRA', False):
    from restapi_extra.sysadmin_extra.views import sys_login_admin, \
...
if getattr(settings, 'MULTI_TENANCY', False):
    urlpatterns += [
        url(r'^api/v2.1/org/', include('restapi_extra.organizations.api_urls')),
        url(r'^org/', include('restapi_extra.organizations.urls')),
    ]
...
from restapi.utils import HAS_OFFICE_CONVERTER, CLUSTER_MODE, OFFICE_CONVERTER_NODE
if HAS_OFFICE_CONVERTER:
    from restapi.views.file import (
    ...
    if CLUSTER_MODE and OFFICE_CONVERTER_NODE:
        urlpatterns += [
...
if getattr(settings, 'ENABLE_ADFS_LOGIN', False):
    from restapi_extra.adfs_auth.views import assertion_consumer_service, \
        auth_complete
    urlpatterns += [
...
if getattr(settings, 'ENABLE_CAS', False):
    from restapi_extra.django_cas_ng.views import login as cas_login
    from restapi_extra.django_cas_ng.views import logout as cas_logout
    from restapi_extra.django_cas_ng.views import callback as cas_callback
    urlpatterns += [
