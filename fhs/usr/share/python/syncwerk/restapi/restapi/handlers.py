...
#         # TODO: Don't register signal/hanlders during Restapi start.
#         from utils import SyncwEventsSession

#         session = SyncwEventsSession()
#         if org_id > 0:
#             syncwevents.save_org_user_events(session, org_id, etype, detail, users, None)
#         else:
#             syncwevents.save_user_events(session, etype, detail, users, None)
#         session.close()
