...
from restapi.admin_log.models import GROUP_DELETE
from restapi.api2.utils import to_python_boolean, api_error
        ...
        try:
            if is_org_context(request):
                ...
                group_id = ccnet_api.create_group(group_name, group_owner,
                                                  parent_group_id=parent_group)
            syncwerk_api.set_group_quota(group_id, -2)
...
class AdminAddressBookGroup(APIView):
    ...
    def delete(self, request, group_id):
        ...
        try:
            has_repo = syncwerk_api.if_group_has_group_owned_repo(group_id)
