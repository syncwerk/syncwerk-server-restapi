...
from restapi.utils import get_file_ops_stats_by_day, \
...
from restapi.utils.file_size import byte_to_mb
from restapi.views.sysadmin import _populate_user_quota_usage
...
class SystemUserTrafficExcelView(APIView):
    ...
    def get(self, request):
        ...
        try:
            res_data = syncwevents_api.get_all_users_traffic_by_month(month_obj, -1, -1)
