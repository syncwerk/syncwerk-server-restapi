...
from restapi.share.utils import update_user_dir_permission, \
...
from restapi.utils import is_valid_username, send_perm_audit_msg
    ...
    def delete(self, request, repo, path, share_type):
        ...
        if share_type == 'user':
            ...
            try:
                ...
                if path == '/':
                    syncwerk_api.remove_share(repo.repo_id, repo_owner, email)
                else:
        ...
        if share_type == 'group':
            ...
            try:
                ...
                if path == '/':
                    syncwerk_api.unset_group_repo(repo.repo_id, group_id, repo_owner)
                else:
