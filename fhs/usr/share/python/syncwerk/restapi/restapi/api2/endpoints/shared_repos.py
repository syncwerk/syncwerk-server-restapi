...
from restapi.constants import PERMISSION_READ, PERMISSION_READ_WRITE, PERMISSION_ADMIN
from restapi.share.utils import update_user_dir_permission, update_group_dir_permission,\
    ...
    def get(self, request, format=None):
        ...
        try:
            if is_org_context(request):
                ...
                shared_repos += syncwerk_api.get_org_group_repos_by_owner(org_id, username)
                shared_repos += syncwerk_api.list_org_inner_pub_repos_by_owner(org_id, username)
            else:
