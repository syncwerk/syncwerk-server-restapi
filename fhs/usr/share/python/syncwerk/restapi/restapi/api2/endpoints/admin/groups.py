...
from restapi.utils import is_valid_username, is_pro_version
...
def get_group_info(group_id):
    ...
    group_info = {
        ...
        "quota": syncwerk_api.get_group_quota(group_id) if is_pro_version() else 0,
...
class AdminGroup(APIView):
    ...
    def put(self, request, group_id):
        ...
        if group_quota:
            ...
            try:
                syncwerk_api.set_group_quota(group_id, group_quota)
