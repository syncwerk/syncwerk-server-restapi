...
from restapi.api2.endpoints.utils import check_time_period_valid, \
...
from restapi.api2.endpoints.utils import get_user_name_dict, \
        ...
        if events:
            ...
            for ev in events:
                ...
                if repo:
                    ...
                    ev.repo_owner = syncwerk_api.get_repo_owner(repo_id) or \
