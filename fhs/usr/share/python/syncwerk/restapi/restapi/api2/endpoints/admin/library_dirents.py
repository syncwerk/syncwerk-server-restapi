...
class AdminLibraryDirents(APIView):
    ...
    def get(self, request, repo_id, format=None):
        ...
        try:
            dirs = syncwerk_api.list_dir_with_perm(repo_id,
    ...
    def post(self, request, repo_id, format=None):
        ...
        try:
            if is_file == 'true':
                syncwerk_api.post_empty_file(repo_id, parent_dir, obj_name, username)
            else:
...
class AdminLibraryDirent(APIView):
    ...
    def put(self, request, repo_id):
        ...
        if dst_repo_id != src_repo_id and not syncwerk_api.get_repo(dst_repo_id):
        ...
        if dst_dir != '/':
            ...
            if not syncwerk_api.get_dir_id_by_path(dst_repo_id, dst_dir):
        ...
        dst_obj_name = check_filename_with_rename(dst_repo_id, dst_dir,
                src_obj_name)
        try:
            syncwerk_api.copy_file(src_repo_id, src_dir, src_obj_name, dst_repo_id,
