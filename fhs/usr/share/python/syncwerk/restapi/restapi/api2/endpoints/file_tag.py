...
from restapi.tags.models import FileTag
...
def check_parameter(func):
    ...
    def _decorated(view, request, *args, **kwargs):
        ...
        if is_dir:
            dir_id = syncwerk_api.get_dir_id_by_path(repo_id, new_file_path)
            if not dir_id:
            ...
            file_id = syncwerk_api.get_file_id_by_path(repo_id, new_file_path)
            if not file_id:
