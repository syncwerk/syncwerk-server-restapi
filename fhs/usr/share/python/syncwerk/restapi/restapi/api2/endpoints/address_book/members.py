...
from restapi.api2.endpoints.search_user import search_user_from_ccnet, \
...
class AddressBookGroupsSearchMember(APIView):
    ...
    def get(self, request, group_id):
        ...
        # search user from the whole Syncwerk system
        email_list = []
        ...
        for email in group_email_list:
            ...
            # if email searched from the whole Syncwerk system
