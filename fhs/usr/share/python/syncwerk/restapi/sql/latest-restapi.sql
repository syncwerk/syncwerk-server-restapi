...
CREATE TABLE IF NOT EXISTS `tenants_tenantadmin` (
  ...
  PRIMARY KEY (`id`),
  KEY `tenants_institu_tenant_id_1e9bb58b_fk_instituti` (`tenant_id`),
  KEY `tenants_tenantadmin_user_c71d766d` (`user`),
  CONSTRAINT `tenants_institu_tenant_id_1e9bb58b_fk_instituti` FOREIGN KEY (`tenant_id`) REFERENCES `tenants_tenant` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

/*!40000 ALTER TABLE `tenants_tenantadmin` DISABLE KEYS */;
/*!40000 ALTER TABLE `tenants_tenantadmin` ENABLE KEYS */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE IF NOT EXISTS `tenants_tenantquota` (
  ...
  `tenant_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `tenants_institu_tenant_id_d23201d9_fk_instituti` (`tenant_id`),
  CONSTRAINT `tenants_institu_tenant_id_d23201d9_fk_instituti` FOREIGN KEY (`tenant_id`) REFERENCES `tenants_tenant` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

/*!40000 ALTER TABLE `tenants_tenantquota` DISABLE KEYS */;
/*!40000 ALTER TABLE `tenants_tenantquota` ENABLE KEYS */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
